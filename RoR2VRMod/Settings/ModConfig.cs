...
namespace VRMod
{
    ...
    public static class ModConfig
    {
        ...
        internal static ConfigEntry<CameraTrackingMode> CameraTracking { get; private set ; }
        internal static ConfigEntry<bool> RelativeCameraSetStereoView { get; private set ; }
        internal static ConfigEntry<int> VrCameraDepth { get; private set ; }
        internal static ConfigEntry<int> VrUiLayerOverride { get; private set ; }
        internal static ConfigEntry<bool> AlignCameraToHorizon { get; private set ; }
        internal static ConfigEntry<float> CameraPositionOffsetX { get; private set ; }
        internal static ConfigEntry<float> CameraPositionOffsetY { get; private set ; }
        internal static ConfigEntry<float> CameraPositionOffsetZ { get; private set ; }
        internal static ConfigEntry<bool> OverrideDepth { get; private set ; }
        internal static ConfigEntry<bool> PhysicsMatchHeadsetRefreshRate { get; private set ; }
        internal static ConfigEntry<UiPatchMode> PreferredUiPatchMode { get; private set ; }
        internal static ConfigEntry<UiRenderMode> PreferredUiRenderMode { get; private set ; }
        internal static ConfigEntry<ScreenSpaceCanvasType> ScreenSpaceCanvasTypesToPatch { get; private set ; }
        internal static ConfigEntry<VrApi> PreferredVrApi { get; private set ; }
        ...
        internal static void Init()
        {
            ...
            RelativeCameraSetStereoView = configFile.Bind(
                "Relative Camera",
            ...
            PhysicsMatchHeadsetRefreshRate = configFile.Bind(
                "General",
            ...
            PreferredUiPatchMode = configFile.Bind(
                "UI",
                "UI Patch Mode",
                UiPatchMode.Mirror,
                "Method to use for patching UI for VR.");

            VrUiLayerOverride = configFile.Bind(
                "UI",
            ...
            ScreenSpaceCanvasTypesToPatch = configFile.Bind(
                "UI",
            ...
            PreferredUiRenderMode = configFile.Bind(
                "UI",
